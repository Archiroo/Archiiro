    ...
    <form action="" method="POST" class="register" enctype="multipart/form-data">
        ...
        <div class="inputBox">
            ...
            <div class="input">
                ...
                if ($image1 != null) {
                ?>
                    <img name="image1" class="imageView" src="../image/image_database/<?php echo $image1; ?>" alt="">
                <?php
                } else {
                ?>
        ...
        <div class="listImage">
            <div class="formImage">
                <div class="imageFile" style="margin-right: 9rem;">
                    ...
                    if ($image2 != null) {
                    ?>
                        <img class="imageMain" src="../image/image_database/<?php echo $image2; ?>" alt="">
                    <?php
                    } else {
                    ?>
                        <span class="imageMain">Không có ảnh</span>
                ...
                <div class="imageFile">
                    ...
                    if ($image3 != null) {
                    ?>
                        <img  class="imageMain" src="../image/image_database/<?php echo $image3; ?>" alt="">
                    <?php
                    } else {
                    ?>
                        <span class="imageMain">Không có ảnh</span>
            ...
            <div class="formImage">
                <div class="imageFile" style="margin-right: 9rem;">
                    ...
                    if ($image4 != null) {
                    ?>
                        <img  class="imageMain" src="../image/image_database/<?php echo $image4; ?>" alt="">
                    <?php
                    } else {
                    ?>
                        <span class="imageMain">Không có ảnh</span>
                ...
                <div class="imageFile">
                    ...
                    if ($image5 != null) {
                    ?>
                        <img class="imageMain" src="../image/image_database/<?php echo $image5; ?>" alt="">
                    <?php
                    } else {
                    ?>
                        <span class="imageMain">Không có ảnh</span>
